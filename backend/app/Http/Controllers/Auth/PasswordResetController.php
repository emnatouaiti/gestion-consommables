...
class PasswordResetController extends Controller
{
    ...
    public function sendResetLink(Request $request)
    {
        ...
        return response()->json([
            'message' => 'Code de rÃƒAinitialisation envoyÃƒA par email'
        ]);
    }
    ...
    public function verifyCode(Request $request)
    {
        ...
        if (!$resetRecord) {
            throw ValidationException::withMessages([
                'code' => ['Code invalide ou expirÃƒA.'],
            ]);
        }
        ...
        if (now()->diffInMinutes($resetRecord->created_at) > 15) {
            ...
            throw ValidationException::withMessages([
                'code' => ['Ce code a expirÃƒA. Veuillez demander un nouveau code.'],
            ]);
        }
        ...
        return response()->json([
            'message' => 'Code vÃƒArifiÃƒA avec succÃƒA¨s',
            'email' => $request->email,
        ]);
    }
    ...
    public function reset(Request $request)
    {
        ...
        return response()->json([
            'message' => 'Mot de passe rÃƒAinitialisÃƒA avec succÃƒA¨s'
        ]);
    }
}
